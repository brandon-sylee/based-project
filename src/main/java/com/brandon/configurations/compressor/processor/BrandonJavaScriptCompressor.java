 ...
 */
public class BrandonJavaScriptCompressor {
    ...
    public BrandonJavaScriptCompressor(Reader in, ErrorReporter reporter)
    ...
    */
    ...
    public String compress() throws IOException {
        return compress(-1, true, false, false, false);
    }
    ...
    public void compress(Writer out, int linebreak, boolean munge, boolean verbose,
            ...
            throws IOException {
        out.write(compress(linebreak, munge, verbose, preserveAllSemiColons, disableOptimizations));
    }
